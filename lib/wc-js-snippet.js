class JsSnippetComponent extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    mainContainer.style = 'margin: 1em;';
    mainContainer.style.height = 'inherit';
    mainContainer.style.width = 'inherit';
    ...
    loopGuardForm.innerHTML = `
      <input id='active' name='active' name='active' type='checkbox'/> <label for='active'>loop guards</label>
